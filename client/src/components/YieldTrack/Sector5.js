...
export default class EquipmentDetails extends Component{
    ...
    async change(e) {
      ...
      axios.get(`http://localhost:3001/infrastructure/getEquipmentDetails?location=San Jose&month=${this.state.month}`)
       .then(res => {
    ...
    handleSave(e){
        ...
        this.state.records.map((record,index) => {
            axios.post("http://localhost:3001/infrastructure/saveEquipmentDetails",{
    ...
    async handleDelete(e){
        ...
        axios.get(`http://localhost:3001/infrastructure/deleteEquipmentDetails?location=San+Jose&month=${this.state.month}&equipment_name=${removeContent.equipment_name}`)
       .then(res => {
            console.log(res.data);
            this.setState({
                msg: res.data
        ...
        return(
          <Form>
              ...
              <div className="alt-rentd-data">
                <label className="alt-rentd-data-label">Equipment Name</label>
              ...
              {this.state.records.map((record,index) => (
                  <div className="alt-rentd-records">
                      <input className="alt-rentd-records-input1" onChange={this.handleChange} name="equipment_name" value={record.equipment_name} id={index} />
