...
export default class FurnitureCosts extends Component{
    constructor(){
        super();
        this.state={
             month:"",
    ...
    async change(e) {
      ...
      axios.get(`http://localhost:3001/infrastructure/getFurnitureDetails?location=San Jose&month=${this.state.month}`)
       .then(res => {
    ...
    handleSave(e){
        ...
        this.state.records.map((record,index) => {
            axios.post("http://localhost:3001/infrastructure/saveFurnitureCosts",{
                location: record.location,
                month: record.month,
                furniture_item: record.furniture_item,
    ...
    async handleDelete(e){
        ...
        axios.get(`http://localhost:3001/infrastructure/deleteFurnitureDetails?location=San Jose&month=${this.state.month}&furniture_item=${removeContent.furniture_item}`)
       .then(res => {
            console.log(res.data);
            this.setState({
                msg: res.data
        ...
        return(
          <Form>
              <div className="alt-rentd-header">
                 <p className="alt-rentd-heading">Furniture Costs</p>
              ...
              <div className="alt-rentd-data">
                <label className="alt-rentd-data-label">Furniture Item</label>
              ...
              {this.state.records.map((record,index) => (
                  <div className="alt-rentd-records">
                      <input className="alt-rentd-records-input1" onChange={this.handleChange} name="furniture_item" value={record.furniture_item} id={index} />
